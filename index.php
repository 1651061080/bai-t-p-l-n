...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./css/grade_new.css">
			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li class="mn-item" item-id="1"><a href="../html/trangdautest.html"><IMG src="./IMG/LOGO1.PNG" width="150PX" height="150PX"><a href="./trangdautest.html"></a>
						</li>
	...
	<div class="container action">
		<div class="container banner">
			...
			<div class="row grade-row1">
				<div class="span1_5"><a href="" title="Luyện toán mẫu giáo" class="grade grad-pink"><span class="grade-lop">Mẫu
							giáo</span><span class="grade-number">0</span></a></div>
				<div class="span1_5"><a href="./html/lop1.html" title="Toán lớp 1" class="grade grad-green"><span class="grade-lop">Toán
							lớp</span><span class="grade-number">1</span></a></div>
				<div class="span1_5"><a href="./html/lop2.html" title="Toán lớp 2" class="grade grad-red"><span class="grade-lop">Toán
							lớp</span><span class="grade-number">2</span></a></div>
				<div class="span1_5"><a href="./html/lop3.html" title="Toán lớp 3" class="grade grad-orange"><span class="grade-lop">Toán
							lớp</span><span class="grade-number">3</span></a></div>
				<div class="span1_5"><a href="./html/lop4.html" title="Toán lớp 4" class="grade grad-blue"><span class="grade-lop">Toán
							lớp</span><span class="grade-number">4</span></a></div>
				<div class="span1_5"><a href="./html/lop5.html" title="Toán lớp 4" class="grade grad-blue"><span class="grade-lop">Toán
